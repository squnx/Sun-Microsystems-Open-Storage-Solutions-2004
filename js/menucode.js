		...
		while (navmenu[x+'.1']){
			...
			if (itemnlink[1]){
				...
				<div style="width:'+mwidth+'px" class="menulink'+ml+'" onmouseover="clrmenu(\''+x+'_0\');" id="'+x+'_0" onclick="'+clickaction+'document.location = \''+itemnlink[1]+'\'">\
					<a href="'+itemnlink[1]+'" class="menulink"  onfocus="clrmenu(\''+x+'_0\');" onblur="hideA2(0);" id="mlink'+x+'_0" '+fullclick+' title="'+seeall+' '+itemnlink[0]+'">'+seeall+' <img src="'+imdir+'/a.gif" width="1" height="1" alt="'+itemnlink[0]+'" border="0"><\/a>&raquo;\
				<\/div>\n';
			}
			thismenu = '\
			<div class="flymenus" style="width:'+mtwidth+'px" id="flymenu'+x+'">\
				<div style="background:'+mitembgD+'"><img src="'+imdir+'\/a.gif" alt="" height="5" width="1" border="0">'+thismenu+'</div>\
